...
- Establish enough class, combat, magic, and item direction that NPCs, mobs, items, and zones can be built with confidence.
...
| Audit strange THAC0 / THAC32 behavior | Investigate | Understand current combat math before any combat rewrite or class overhaul. |
...
| Item | Status | Notes |
| --- | --- | --- |
| Let anyone learn magic | Design needed | Magic should not be mage-only. Need decide how classes, trainers, skill tables, and practice interact with spell access. |
...
| Build class system enough for mobs/NPCs/items | Design needed | Needed before serious mob and item building. Rooms can still be built while this is unresolved. |
...
### Character Identity and Classes
...
| Add alternate means of distinguishing PCs | Design needed | Needed if race variety is removed. Could involve tribe, mask, background, culture, origin, faction, education, vocation, illness exposure, or precursor knowledge. |
| Class overhaul | Design needed | Required direction, but must follow combat, magic, skills, practice, group, equipment, and NPC-building analysis. |

### Combat and Magic Overhauls

| Item | Status | Notes |
| --- | --- | --- |
| Understand combat before major redesign | Investigate | Required before class overhaul. Document hit flow, damage, THAC0/THAC32, saves, skills, conditions, positions, and NPC behavior. |
| Combat overhaul | Deferred | Do not scope until current combat is understood and class goals are clearer. |
| Magic overhaul | Design needed | Touches classes, skills, spells, saves, HP costs, remort rewards, detect spells, lore, item effects, and magic illness. |
...
6. THAC0/THAC32 combat math investigation.
7. Item level policy: data edit, code edit, or combined approach.
8. Login screen replacement.
...
- Are player files considered migration targets, or can early development assume fresh characters?
    - Answer: Assume all players will be deleted eventually - this will likely happen around the time we start implementing custom classes etc

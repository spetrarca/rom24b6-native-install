...
| Treat magical item HP costs as true damage | Complete | Decision: scroll, staff, and wand HP costs subtract the exact calculated current HP cost and are not reduced by sanctuary, resistances, protection, armor, or other combat damage mitigation. Lethal item use should still use the standard death presentation and aftermath. |
